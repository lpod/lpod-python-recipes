...
# -*- coding: UTF-8 -*-
"""
This recipe caters for instance for the scenario where an organization switches
from one corporate logo to another, and has to replace the logo in many
...
if  __name__ == '__main__':
    ...
    parser.add_option("-o", "--old", dest="old_img",
                      help="Old picture file name",
                      action="store", type="string")
    parser.add_option("-n", "--new", dest="new_img",
