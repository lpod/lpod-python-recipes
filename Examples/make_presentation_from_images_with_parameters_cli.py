...
if  __name__ == '__main__':
    ...
    parser.add_option("-o", "--output", dest="output", help="write output to OUTPUT",
                      action="store", type="string")
    parser.add_option("-m", "--max", dest="crop", help="extend images on slide (default)",
                      action="store_false")
    parser.add_option("-s", "--size", dest="size", help="max width in cm of the images",
                      action="store", type="float")
    parser.add_option("-c", "--crop", dest="crop", help="crop images to use all space",
                      action="store_true")
