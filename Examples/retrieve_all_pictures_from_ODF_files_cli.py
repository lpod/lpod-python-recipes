...
def store_image(path, name, content, dest_dir=default_dest_dir):
    ...
    dest_file = os.path.join(dest_dir.decode(encoding), u"%s_%s" %
            (os.path.basename(path).decode(encoding).replace(u'.',u'_'),
...
if  __name__ == '__main__':
    ...
    parser.add_option("-d", "--directory", dest="directory", help="write images in DIRECTORY",
